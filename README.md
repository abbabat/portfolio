...
The core site works without JavaScript. Enhancements respect reduced motion, support keyboard use, and avoid runtime dependencies and external fonts. Project filtering uses native buttons with pressed states; work details use native disclosure elements.
